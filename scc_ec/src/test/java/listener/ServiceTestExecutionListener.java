...
/*			XlsDataFileLoader xlsDataFileLoader = (XlsDataFileLoader) testCtx.getApplicationContext().getBean("xlsDataFileLoader");
			...
			FlatXmlDataFileLoader flatXmlDataFileLoader = (FlatXmlDataFileLoader) testCtx.getApplicationContext().getBean("xmlDataFileLoader");
            IDataSet dataSet=flatXmlDataFileLoader.load(dataSetName);
